    ...
    <section>
      ...
      <div className={styles.moviesLayout}>
        <aside className={styles.sidebar}>
          ...
          <NavLink to="/movies" end className={genreClass}>전체</NavLink>
          <NavLink to="/movies/drama" className={genreClass}>드라마</NavLink>
          <NavLink to="/movies/action" className={genreClass}>액션</NavLink>
          <NavLink to="/movies/romance" className={genreClass}>로맨스</NavLink>
        </aside>
